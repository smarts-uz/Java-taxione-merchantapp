...
public class com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy extends com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel
    implements RealmObjectProxy, com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface {

    static final class CategoryItemNonModelColumnInfo extends ColumnInfo {
        long category_item_idColKey;
        long category_name_itemColKey;
        long category_statusColKey;
        long total_itemColKey;

        CategoryItemNonModelColumnInfo(OsSchemaInfo schemaInfo) {
            super(4);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("CategoryItemNonModel");
        ...
        CategoryItemNonModelColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new CategoryItemNonModelColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final CategoryItemNonModelColumnInfo src = (CategoryItemNonModelColumnInfo) rawSrc;
            final CategoryItemNonModelColumnInfo dst = (CategoryItemNonModelColumnInfo) rawDst;
    ...
    private CategoryItemNonModelColumnInfo columnInfo;
    private ProxyState<com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (CategoryItemNonModelColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("CategoryItemNonModel", 4, 0);
    ...
    public static CategoryItemNonModelColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new CategoryItemNonModelColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "CategoryItemNonModel";
    }

    @SuppressWarnings("cast")
    public static com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel obj = realm.createObjectInternal(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class, true, excludeFields);

        final com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface objProxy = (com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) obj;
    ...
    public static com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel obj = new com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel();
        final com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface objProxy = (com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class), false, Collections.<String>emptyList());
        io.realm.com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy obj = new io.realm.com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel copyOrUpdate(Realm realm, CategoryItemNonModelColumnInfo columnInfo, com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel copy(Realm realm, CategoryItemNonModelColumnInfo columnInfo, com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel) cachedRealmObject;
        }

        com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface realmObjectSource = (com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) newObject;

        Table table = realm.getTable(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class);
        ...
        io.realm.com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class);
        long tableNativePtr = table.getNativePtr();
        CategoryItemNonModelColumnInfo columnInfo = (CategoryItemNonModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class);
        long colKey = OsObject.createRow(table);
        cache.put(object, colKey);
        String realmGet$category_item_id = ((com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) object).realmGet$category_item_id();
        ...
        String realmGet$category_name_item = ((com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) object).realmGet$category_name_item();
        ...
        String realmGet$category_status = ((com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) object).realmGet$category_status();
        ...
        String realmGet$total_item = ((com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) object).realmGet$total_item();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        CategoryItemNonModelColumnInfo columnInfo = (CategoryItemNonModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class);
        com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel object = null;
        while (objects.hasNext()) {
            object = (com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel.class);
    ...
    public static com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel createDetachedCopy(com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel) cachedObject.object;
            }
            unmanagedObject = (com.ourdevelops.ornidsmerchant.models.CategoryItemNonModel) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface unmanagedCopy = (com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) unmanagedObject;
        com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface realmSource = (com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("CategoryItemNonModel = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy aCategoryItemNonModel = (com_ourdevelops_ornidsmerchant_models_CategoryItemNonModelRealmProxy)o;

        BaseRealm realm = proxyState.getRealm$realm();
        BaseRealm otherRealm = aCategoryItemNonModel.proxyState.getRealm$realm();
        ...
        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aCategoryItemNonModel.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getObjectKey() != aCategoryItemNonModel.proxyState.getRow$realm().getObjectKey()) return false;
